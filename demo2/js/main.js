...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_2__.validateForms)(".js-contacts-form", rules, afterForm); // const afterForm = () => {
//   console.log('Произошла отправка, тут можно писать любые действия');
// };
...
/***/ "./src/js/components/auto-carousel.js":
/*!********************************************!*\
  !*** ./src/js/components/auto-carousel.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _require = __webpack_require__(/*! ../functions/accordion */ "./src/js/functions/accordion.js"),
...
var Accordion = /*#__PURE__*/function () {
  function Accordion(el) {
    ...
    this.summary = el.querySelector(".js-summary"); // Store the <div class="content"> element

    this.content = el.querySelector(".js-content"); // Store the animation object (so we can cancel it if needed)
...
var validateForms = function validateForms(selector, rules, afterSend) {
  ...
  if (telSelector) {
    var inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())({
  ...
  validation.onSuccess(function (ev) {
    var formData = new FormData(ev.target); // раскомментировать
